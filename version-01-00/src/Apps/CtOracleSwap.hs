...
module Apps.CtOracleSwap where
...
offer oracle amt = do
    logInfo @String $ printf "-------------------- Offering to Swap --------------------" 
...
retrieve oracle = do
    logInfo @String $ printf "-------------------- Retrieving Swap rewards --------------------"
    pkh <- unPaymentPubKeyHash <$> Contract.ownPaymentPubKeyHash
...
use oracle amt = do
    logInfo @String $ printf "-------------------- Accepting Offer to Swap --------------------"
